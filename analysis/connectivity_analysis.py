...
MODEL_PATH_TEMPLATE = "deposition_runs/ip_{0}n/whole_n{0}.gro"
MODEL_CACHE_TEMPLATE = "cached_modles.pickle"
USE_CACHE = False
WPC = (45,)#(15, 40, 45, 108, 209)
...
def main():
    ...
    cutoff_distances = [1.25, 1.5, 1.75, 2.0]#np.linspace(0.7,1,3)# [1.25, 1.5, 1.75, 2.0]
    models = load_models()
    stats = {}
